package primao.levandowski.searchcriptocon.searchablespinnerlibrary;
...
import primao.levandowski.searchcriptocon.R;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strPositiveButton = _strPositiveButtonText == null ? "Fechar" : _strPositiveButtonText;
        alertDialog.setPositiveButton(strPositiveButton, _onClickListener);

        String strTitle = _strTitle == null ? "Pesquisar Moedas" : _strTitle;
